                           ...
                           <div class="col-lg-10">
                                        ...
                                        @enderror
                                            <div class="form-group">
                                                ...
                                                <input id="image-upload" name="image" type="file" class="form-control cc-number identified visa" value="" data-val="true"
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="product_child_image" name="product_child_image[]" type="file" class="form-control cc-number identified visa" value="" data-val="true"
                                                multiple >
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="slug" name="slug" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="brand" name="brand" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="model" name="model" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="keyword" name="keyword" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="technical_specification" name="technical_specification" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="uses" name="uses" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="warranty" name="warranty" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="image" name="attribute_image" type="file" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                            ...
                                            <div class="col-lg-6">
                                                 <div class="form-group">
                                                <label for="prodduct_child_image" class="control-label mb-1">Product Attribute Child Image</label>
                                                <input id="product_Attribute_child_image" name="product_Attribute_child_image[]" type="file" class="form-control cc-number identified visa" value="" data-val="true"
                                                multiple >
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            </div>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-number" name="quantity" type="number" class="form-control cc-number identified visa" value="" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
