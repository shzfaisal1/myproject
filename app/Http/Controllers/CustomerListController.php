...
class CustomerListController extends Controller
{
    ...
    public function edit($id){
        ...
        $edit=DB::table('customer_lists')->where('id','=',$id)->first();
        return view('ecommerce.backend.admin.dashbord.customer_list.edit',compact('edit'));
        }
    /**
...
$customer=DB::table('customer_lists')->where('id',$id)->first();
