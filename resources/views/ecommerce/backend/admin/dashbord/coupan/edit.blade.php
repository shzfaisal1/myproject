                           ...
                           <div class="col-lg-10">
                                        ...
                                        <form action="{{url('coupon/update')}}/{{$data->id}}" method="post" novalidate="novalidate">
                                           @csrf
                                            <div class="form-group has-success">
                                                ...
                                                <input id="Title" name="Title" type="text" class="form-control cc-name valid" value="{{$data->Title}}" data-val="true" data-val-required="Please enter the name on card"
                                        ...
                                        @enderror
                                            <div class="form-group">
                                                ...
                                                <input id="category_slug" name="Code" type="text"  value="{{$data->Code}}" class="form-control cc-number  identified visa"  data-val="true"
                                        ...
                                        @enderror
                                            <div class="form-group">
                                                ...
                                                <input id="category_slug" name="Calue" type="number" class="form-control cc-number identified visa" value="{{$data->Calue}}" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
